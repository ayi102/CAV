// Dafny program C:\Users\Ali\Documents\UCB2013-2014\Semester1\ComputerAidedVerification\assignment4\test.dfy compiled into C#
...
public class @__default {
  public void @expon(BigInteger @n, BigInteger @e, out BigInteger @r)
  {
    @r = new BigInteger(0);
  TAIL_CALL_START: ;
    var _this = this;
    BigInteger @_3_b = new BigInteger(0);
    @_3_b = @e;
    @r = new BigInteger(1);
    while ((@_3_b) > (new BigInteger(0)))
    {
      @r = (@r) * (@n);
      @_3_b = (@_3_b) - (new BigInteger(1));
    }
  }
}
